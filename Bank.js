function Transfer() 
{
var myaccount=parseInt(document.getElementById('DeepeshBalance').innerText);
...
let myaccount=parseInt(document.getElementById('DeepeshBalance').innerText)-transfer_Amount;
...
document.getElementById('DeepeshBalance').innerText=myaccount;
alert("Continue")
document.getElementById('DeepeshBalance').innerText=myaccount;
